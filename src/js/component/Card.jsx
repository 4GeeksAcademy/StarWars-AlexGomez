...
export const Card = (props) => {
  ...
  useEffect(() => {
    const defaultImage = `https://starwars-visualguide.com/assets/img/${props.type === "people" ? "characters" : props.type}/6.jpg`;
    ...
    if (props.type === "starships") {
      ...
      imageUrl = `https://starwars-visualguide.com/assets/img/films/${Films[props.imgIdF]}.jpg`;
      ...
      imageUrl = `https://starwars-visualguide.com/assets/img/vehicles/${car[props.imgIdc-1]}.jpg`;
    ...
    <div className="cards">
      <div className="card-header">
        ...
        <div>
          ...
          {props.type === "people" && <p className="rank">{props.birth_year}</p>}
          {props.type === "planets" && <p className="rank">{props.climate}</p>}
          {props.type === "vehicles" && <p className="rank">{props.vehicle_class}</p>}
          {props.type === "species" && <p className="rank">{props.classification}</p>}
          {props.type === "starships" && <small className="rank">{props.model}</small>}
          {props.type === "films" && <small className="rank">{props.director}</small>}
        </div>
      </div>

      {["people","films", "planets", "vehicles", "species", "starships"].includes(props.type) && (
        <>
